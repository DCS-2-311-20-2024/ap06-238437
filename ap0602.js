...
function init() {
  ...
  const renderer = new THREE.WebGLRenderer();
  {
    ...
    renderer.setSize(
      0.7*window.innerWidth,//window.innerWidth,
      0.5*window.innerWidth);//window.innerHeight - nameHeight);
  ...
  const renderer2 = new THREE.WebGLRenderer();
  {
    ...
    renderer2.setSize(
      0.3*window.innerWidth,//window.innerWidth,
      0.6*window.innerWidth);//window.innerHeight - nameHeight);
